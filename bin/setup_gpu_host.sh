...
echo "  hopper upstream invite --create"
echo ""
echo "  # Send the token to ${HOSTNAME}, then on THIS host run:"
echo "  cd ~/rosetta_queue && hopper upstream redeem <TOKEN>"
echo ""
echo "  # Verify the host is recognised:"
echo "  hopper upstream status"
echo ""
echo "  # Pull all current tasks to this host:"
echo "  cd ~/rosetta_queue && hopper upstream sync"
echo ""
echo "======================================================================"
echo ""
